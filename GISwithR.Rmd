...
```{r}
wallabies <- read.csv("~/Desktop/Swamp wallabies on Phillips Island, Australia.csv")
str(wallabies)
...
```{r}
ph <- st_read("/Users/rvalavi/Desktop/Phillip_island.shp")
...
dem <- raster("/Users/rvalavi/Desktop/ASTGTM2_S39E145_dem.tif")
...
st_layers("~/Desktop/EcoloGIS.gpkg")
...
roads <- st_read("~/Desktop/roads.gpkg", quiet = TRUE) %>% 
...
```{r eval=FALSE}
st_write(wlb_proj, "~/Desktop/wallabies.gpkg")
